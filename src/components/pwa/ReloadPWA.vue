		...
		<div class="relative px-4 w-full max-w-md h-auto">
			...
			<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
				...
				<div class="p-6 pt-0 text-center">
					<svg @click="close" class="mx-auto mb-4 w-14 h-14 text-gray-400 dark:text-gray-200" fill="none"
						stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
							d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
					</svg>
					<h3 v-if="offlineReady" class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
						La aplicación está lista para funcionar offline.
					</h3>
					<h3 v-else class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
						Nuevo contenido disponible, toque en refrescar para actualizar la página.
					</h3>
					<button v-if="needRefresh" @click="updateServiceWorker()" type="button"
